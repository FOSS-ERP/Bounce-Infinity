...
def execute(filters=None):
	...
	data = [
		row
		for row in data
		if all(not filters.get(source) or row.get(target) == filters[source] for source, target in field_map.items())
	]
...
def _columns():
	return [
		{"fieldname": "serial_no", "label": _("Serial No"), "fieldtype": "Link", "options": "Serial No", "width": 160},
		...
		{"fieldname": "warranty_claim", "label": _("Warranty Claim"), "fieldtype": "Link", "options": "Warranty Claim", "width": 160},
		{"fieldname": "warranty_expiry_date", "label": _("Warranty Expiry"), "fieldtype": "Date", "width": 110},
		{"fieldname": "supplier", "label": _("Supplier"), "fieldtype": "Link", "options": "Supplier", "width": 170},
		{"fieldname": "original_purchase_receipt", "label": _("Original Purchase Receipt"), "fieldtype": "Link", "options": "Purchase Receipt", "width": 180},
		{"fieldname": "original_purchase_rate", "label": _("Original Purchase Rate"), "fieldtype": "Currency", "width": 140},
		...
		{"fieldname": "purchase_return", "label": _("Purchase Return"), "fieldtype": "Link", "options": "Purchase Receipt", "width": 160},
		{"fieldname": "debit_note", "label": _("Debit Note"), "fieldtype": "Link", "options": "Purchase Invoice", "width": 160},
