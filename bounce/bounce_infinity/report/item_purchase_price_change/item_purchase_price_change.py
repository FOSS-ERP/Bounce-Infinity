...
def _columns():
	return [
		...
		{"fieldname": "current_price", "label": _("Current Price"), "fieldtype": "Currency", "options": "currency", "width": 120},
		{"fieldname": "previous_price", "label": _("Previous Price"), "fieldtype": "Currency", "options": "currency", "width": 120},
		{"fieldname": "change_amount", "label": _("Price Change"), "fieldtype": "Currency", "options": "currency", "width": 115},
		...
		{"fieldname": "previous_effective_date", "label": _("Previous Effective From"), "fieldtype": "Date", "width": 150},
		...
		{"fieldname": "supplier", "label": _("Latest Supplier"), "fieldtype": "Link", "options": "Supplier", "width": 170},
		...
		{"fieldname": "source_document", "label": _("Source Document"), "fieldtype": "Dynamic Link", "options": "source_doctype", "width": 170},
	]
